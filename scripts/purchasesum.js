...
function fetchAndRenderPurchaseData(sheetName) {
  ...
  const url = `https://script.google.com/macros/s/AKfycbx96nZGc4TXpyyYDJ2Dvxbqjfp7YLAEff6CzD0DTR9mw8GQeXpVeQPkoNMJ--6EiI53/exec?action=getAllData&sheet_name=${fullSheetName}`;
