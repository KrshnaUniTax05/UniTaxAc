  ...
  let userid = sessionStorage.getItem('userloginid');
  let userId = sessionStorage.getItem('userloginid');
...
document.querySelectorAll('.tosend').forEach(form => {
  form.addEventListener('submit', function(event) {
    ...
    const scriptURL = "https://script.google.com/macros/s/AKfycbx96nZGc4TXpyyYDJ2Dvxbqjfp7YLAEff6CzD0DTR9mw8GQeXpVeQPkoNMJ--6EiI53/exec" + "?callback=handleResponse&unique_code=" + Unique_identifier + "&" + queryString;
...
const baseScriptURL = 'https://script.google.com/macros/s/AKfycbx96nZGc4TXpyyYDJ2Dvxbqjfp7YLAEff6CzD0DTR9mw8GQeXpVeQPkoNMJ--6EiI53/exec';

// Step 1: Start processing all inputs with data-fetch_column
function processFetchableInputs() {
  const inputs = document.querySelectorAll('input[data-fetch_column]');
  
  // console.log('processFetchableInputs')
    // console.log(inputs)
