    ...
    for (const data of formDataToStore) {
      ...
      while (!success && attempt < 5) {
        try {
          ...
          const scriptURL = `https://script.google.com/macros/s/AKfycbx96nZGc4TXpyyYDJ2Dvxbqjfp7YLAEff6CzD0DTR9mw8GQeXpVeQPkoNMJ--6EiI53/exec?callback=processServerReply&${queryString}`;
